...
The YouVersion Platform SDK for Swift provides native iOS and macOS integration for accessing Bible content and YouVersion Platform features.

## Overview

Our Swift SDK enables you to integrate Bible content directly into your iOS and macOS applications. The SDK provides a native Swift interface for accessing Bible translations, books, chapters, and verses with full SwiftUI support.
