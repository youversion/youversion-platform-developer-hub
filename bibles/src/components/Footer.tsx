...
const Footer = () => {
  return (
    <footer className="bg-muted/30 inset-shadow-[0_-1px_0_0_var(--border)] relative">
      {/* Notification Bar */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="hidden">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li className="hidden">
                <a href={`${getPlatformUrl()}/platform/apps`} className="text-muted-foreground hover:text-foreground transition-colors">
                  App Management
                </a>
              </li>
            </ul>
